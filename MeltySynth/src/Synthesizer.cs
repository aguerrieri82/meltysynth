...
namespace MeltySynth
{
    ...
    public sealed class Synthesizer : IAudioRenderer, IDisposable
    {
        ...
        public Synthesizer(string soundFontPath, int sampleRate, bool useMemoryMap = true) : this(new SoundFont(soundFontPath, useMemoryMap), new SynthesizerSettings(sampleRate))
        {
        }
